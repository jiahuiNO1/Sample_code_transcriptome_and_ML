#Bar plot of AUCs across different classification models
#bar plot, group by methods, color by number of genes, * for model with the highest AUC within a method
...
#Combine performance data for blood
...
png("D:/AD_gx/Brain_gx/TRS/20240602_blood_brain_ml_ptrs_performance_for_manu_final_barplot.png", res=600, units="in",height = 12, width = 14)
print(p)
dev.off()
